...
const ::google::protobuf::Descriptor* DooRequest_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  DooRequest_reflection_ = NULL;
const ::google::protobuf::Descriptor* DooResponse_descriptor_ = NULL;
const ::google::protobuf::internal::GeneratedMessageReflection*
  DooResponse_reflection_ = NULL;
...
void protobuf_AssignDesc_helloworld_2eproto() {
  ...
  FooResponse_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      ...
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(FooResponse));
  DooRequest_descriptor_ = file->message_type(2);
  static const int DooRequest_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DooRequest, text_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DooRequest, times_),
  };
  DooRequest_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      DooRequest_descriptor_,
      DooRequest::default_instance_,
      DooRequest_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DooRequest, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DooRequest, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(DooRequest));
  DooResponse_descriptor_ = file->message_type(3);
  static const int DooResponse_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DooResponse, text_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DooResponse, result_),
  };
  DooResponse_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      DooResponse_descriptor_,
      DooResponse::default_instance_,
      DooResponse_offsets_,
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DooResponse, _has_bits_[0]),
      GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(DooResponse, _unknown_fields_),
      -1,
      ::google::protobuf::DescriptorPool::generated_pool(),
      ::google::protobuf::MessageFactory::generated_factory(),
      sizeof(DooResponse));
...
void protobuf_RegisterTypes(const ::std::string&) {
  ...
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    DooRequest_descriptor_, &DooRequest::default_instance());
  ::google::protobuf::MessageFactory::InternalRegisterGeneratedMessage(
    DooResponse_descriptor_, &DooResponse::default_instance());
}
...
void protobuf_ShutdownFile_helloworld_2eproto() {
  ...
  delete DooRequest::default_instance_;
  delete DooRequest_reflection_;
  delete DooResponse::default_instance_;
  delete DooResponse_reflection_;
}
...
void protobuf_AddDesc_helloworld_2eproto() {
  ...
  DooRequest::default_instance_ = new DooRequest();
  DooResponse::default_instance_ = new DooResponse();
  FooRequest::default_instance_->InitAsDefaultInstance();
  FooResponse::default_instance_->InitAsDefaultInstance();
  DooRequest::default_instance_->InitAsDefaultInstance();
  DooResponse::default_instance_->InitAsDefaultInstance();
...
#ifndef _MSC_VER
const int DooRequest::kTextFieldNumber;
const int DooRequest::kTimesFieldNumber;
#endif  // !_MSC_VER

DooRequest::DooRequest()
  : ::google::protobuf::Message() {
  SharedCtor();
}

void DooRequest::InitAsDefaultInstance() {
}

DooRequest::DooRequest(const DooRequest& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void DooRequest::SharedCtor() {
  _cached_size_ = 0;
  text_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  times_ = 0;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
void DooRequest::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* DooRequest::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return DooRequest_descriptor_;
}

const DooRequest& DooRequest::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_helloworld_2eproto();
  return *default_instance_;
}

DooRequest* DooRequest::default_instance_ = NULL;

DooRequest* DooRequest::New() const {
  return new DooRequest;
}

void DooRequest::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (has_text()) {
      if (text_ != &::google::protobuf::internal::kEmptyString) {
        text_->clear();
...
bool DooRequest::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void DooRequest::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required string text = 1;
  if (has_text()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
...
::google::protobuf::uint8* DooRequest::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // required string text = 1;
  if (has_text()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
...
void DooRequest::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const DooRequest* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const DooRequest*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void DooRequest::MergeFrom(const DooRequest& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_text()) {
      set_text(from.text());
...
void DooRequest::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void DooRequest::CopyFrom(const DooRequest& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool DooRequest::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;

  return true;
}

void DooRequest::Swap(DooRequest* other) {
  if (other != this) {
    std::swap(text_, other->text_);
    std::swap(times_, other->times_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
...
::google::protobuf::Metadata DooRequest::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = DooRequest_descriptor_;
  metadata.reflection = DooRequest_reflection_;
  return metadata;
}
...
#ifndef _MSC_VER
const int DooResponse::kTextFieldNumber;
const int DooResponse::kResultFieldNumber;
#endif  // !_MSC_VER

DooResponse::DooResponse()
  : ::google::protobuf::Message() {
  SharedCtor();
}

void DooResponse::InitAsDefaultInstance() {
}

DooResponse::DooResponse(const DooResponse& from)
  : ::google::protobuf::Message() {
  SharedCtor();
  MergeFrom(from);
}

void DooResponse::SharedCtor() {
  _cached_size_ = 0;
  text_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
  result_ = false;
  ::memset(_has_bits_, 0, sizeof(_has_bits_));
...
void DooResponse::SetCachedSize(int size) const {
  GOOGLE_SAFE_CONCURRENT_WRITES_BEGIN();
  _cached_size_ = size;
  GOOGLE_SAFE_CONCURRENT_WRITES_END();
}
const ::google::protobuf::Descriptor* DooResponse::descriptor() {
  protobuf_AssignDescriptorsOnce();
  return DooResponse_descriptor_;
}

const DooResponse& DooResponse::default_instance() {
  if (default_instance_ == NULL) protobuf_AddDesc_helloworld_2eproto();
  return *default_instance_;
}

DooResponse* DooResponse::default_instance_ = NULL;

DooResponse* DooResponse::New() const {
  return new DooResponse;
}

void DooResponse::Clear() {
  if (_has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (has_text()) {
      if (text_ != &::google::protobuf::internal::kEmptyString) {
        text_->clear();
...
bool DooResponse::MergePartialFromCodedStream(
    ::google::protobuf::io::CodedInputStream* input) {
#define DO_(EXPRESSION) if (!(EXPRESSION)) return false
  ::google::protobuf::uint32 tag;
  while ((tag = input->ReadTag()) != 0) {
...
void DooResponse::SerializeWithCachedSizes(
    ::google::protobuf::io::CodedOutputStream* output) const {
  // required string text = 1;
  if (has_text()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
...
::google::protobuf::uint8* DooResponse::SerializeWithCachedSizesToArray(
    ::google::protobuf::uint8* target) const {
  // required string text = 1;
  if (has_text()) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8String(
...
int DooResponse::ByteSize() const {
  int total_size = 0;
...
void DooResponse::MergeFrom(const ::google::protobuf::Message& from) {
  GOOGLE_CHECK_NE(&from, this);
  const DooResponse* source =
    ::google::protobuf::internal::dynamic_cast_if_available<const DooResponse*>(
      &from);
  if (source == NULL) {
    ::google::protobuf::internal::ReflectionOps::Merge(from, this);
  } else {
...
void DooResponse::MergeFrom(const DooResponse& from) {
  GOOGLE_CHECK_NE(&from, this);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_text()) {
      set_text(from.text());
...
void DooResponse::CopyFrom(const ::google::protobuf::Message& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

void DooResponse::CopyFrom(const DooResponse& from) {
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}

bool DooResponse::IsInitialized() const {
  if ((_has_bits_[0] & 0x00000001) != 0x00000001) return false;

  return true;
}

void DooResponse::Swap(DooResponse* other) {
  if (other != this) {
    std::swap(text_, other->text_);
    std::swap(result_, other->result_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
...
::google::protobuf::Metadata DooResponse::GetMetadata() const {
  protobuf_AssignDescriptorsOnce();
  ::google::protobuf::Metadata metadata;
  metadata.descriptor = DooResponse_descriptor_;
  metadata.reflection = DooResponse_reflection_;
  return metadata;
}
